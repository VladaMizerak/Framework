...
public class SignInPO {
    ...
    public SignInPO insertLogin(java.lang.String userLogin, java.lang.String password){
        loginInput.input(java.lang.String.valueOf(userLogin));
        passwordInput.input(java.lang.String.valueOf(password));
